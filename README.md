...
[II.About AdViewSDK_Android-3.4.4](https://github.com/vinith-cit/AdViewSDK_Android-3.4.1/blob/master/README.md#Ⅱabout-adviewsdk_android-341)
...
## Ⅱ.About AdViewSDK_Android-3.4.4

1. Clone or download AdViewSDK_Android-3.4.4 package to go ahead with the integration process. This package contains all files needed for smooth integration and some of the important fils include **AdViewTestDemoEN** and **libs**.
...
1. Clone or download AdViewSDK_Android-3.4.4 package here.In the AdViewSDK_Android-3.4.4 folder contains libs folder ,it contains the SDK for all ad platforms. (Libinfo.pdf has the ad platform instructions corresponding to each jar.)
